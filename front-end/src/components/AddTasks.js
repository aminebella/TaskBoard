...
export default function AddTasks() {
  ...
  const handleSubmit = async (e) => {
    ...
    if(selectedCategory === newCategory){
      axios.post("http://localhost:8000/api/categories", { nameCategory : newCategory , color : newCategoryColor , userId : userId });
    }
      ...
      <div className="container mt-4">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            ...
            >
              <option hidden value="">Choose Existing Category</option>
            ...
            <p className='text-body-secondary text-decoration-underline' style={{textAlign:"right" , cursor:"pointer"}} onClick={()=>setCreateNewCateForm(prev=>!prev)}>Create New Category</p>
            {CreateNewCateForm && ( 
              <span>
                <input
                type="color"
